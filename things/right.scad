// Generated by SolidPython 1.1.2 on 2024-05-04 18:06:58
...
difference() {
	union() {
		...
		union() {
			translate(v = [51.98825631013626, 8.286933679835226, 0.0]) {
				translate(v = [0, 0, 2]) {
					cylinder($fn = 18, h = 6.2000000000, r1 = 3.7500000000, r2 = 3.7500000000);
				}
			}
			translate(v = [49.553541745529685, -41.81412789917408, 0.0]) {
				translate(v = [0, 0, 2]) {
					cylinder($fn = 18, h = 6.2000000000, r1 = 3.7500000000, r2 = 3.7500000000);
				}
			}
			translate(v = [-58.194702563485016, 9.30566972318364, 0.0]) {
				translate(v = [0, 0, 2]) {
					cylinder($fn = 18, h = 6.2000000000, r1 = 3.7500000000, r2 = 3.7500000000);
				}
			}
			translate(v = [-47.72412805058939, -54.40598575660748, 0.0]) {
				translate(v = [0, 0, 2]) {
					cylinder($fn = 18, h = 8.2000000000, r1 = 3.1550000000, r2 = 2.8000000000);
				}
			}
		}
		union() {
	...
	union() {
		...
		union() {
			translate(v = [51.98825631013626, 8.286933679835226, 0.0]) {
				translate(v = [0, 0, 2]) {
					cylinder($fn = 18, h = 4.2000000000, r1 = 1.7500000000, r2 = 1.7500000000);
				}
			}
			translate(v = [49.553541745529685, -41.81412789917408, 0.0]) {
				translate(v = [0, 0, 2]) {
			...
			translate(v = [-47.72412805058939, -54.40598575660748, 0.0]) {
				translate(v = [0, 0, 0]) {
					cylinder($fn = 18, h = 6.2000000000, r1 = 1.7500000000, r2 = 1.7500000000);
				}
			}
		}
		translate(v = [-42.537912117550164, 28.377955392906404, 4]) {
